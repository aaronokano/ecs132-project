...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{firenaivepredict.png}
...
\begin{figure}
  ...
  \centering
  \includegraphics[width=\textwidth]{badhist.png}
  \caption{Distribution of area with raw data}
\end{minipage}
\hspace{0.5cm}
  \begin{minipage}[b]{0.45\linewidth}
  \centering
  \includegraphics[width=\textwidth]{goodhist.png}
...
\begin{figure}
  \begin{minipage}[b]{0.45\linewidth}
  \centering
  \includegraphics[width=\textwidth]{goodfiresowndat.png}
...
\hspace{0.5cm}
  \begin{minipage}[b]{0.45\linewidth}
  \centering
  \includegraphics[width=\textwidth]{goodfiresalldat.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{r2knn.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{knn_prop_pred.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{parkinson.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{forestfire.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{knn_good_whole.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{knn_good_own.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{knn_good_all.png}
  \caption{Plot of prediction vs real for nearest-neighbor with restricted data
