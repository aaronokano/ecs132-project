...
were predicted correctly. We think this model is the best model for classifying the Parkinson status since we did not see any improvement by adding other predictor variables or adding interaction terms. Also, we do not think we have to worry about independence in this case 
because our model has only one predictor variable.  
